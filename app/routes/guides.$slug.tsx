...
export async function loader({ params, context }: Route.LoaderArgs) {
  ...
  const [
    ...
    client
      ...
      .select(
        "id, slug, kind, title, summary, days, price_usd_cents, price_breakdown, max_party, cover_photo_url, route_id, guide_slug, guide_name, guide_avatar_url, guide_tier, guide_day_rate_usd_cents",
      )
      .eq("guide_id", guide.user_id),
    client
      .from("availability")
