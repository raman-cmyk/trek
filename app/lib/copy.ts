...
export const copy = {
  ...
  routes: {
    searchLabel: "Search the routes",
    searchPlaceholder: "Everest, Annapurna, easy, 10 days…",
    search: "Search",
    moreFilters: "Month, length & difficulty",
    fewerFilters: "Fewer options",
    monthLabel: "The month you can travel",
    anyMonth: "Any month",
    goingIn: "Going in {month}",
    daysLabel: "How long you have",
    anyLength: "Any length",
    difficultyLabel: "How hard",
    anyDifficulty: "Any difficulty",
    regionLabel: "Which part of Nepal",
    anyRegion: "Anywhere in Nepal",
    clear: "Clear",
    countAll: "{total} routes. Zero brochure clichés.",
    countMatching: "{shown} of {total} routes",
    noneHead: "Nothing matches that.",
    noneBody:
      "Try one word — a mountain, a region, or the month you can travel. Or see all of them and pick from the list.",
    showAll: "Show all {total} routes",
  },
  meeting: {
    where: "Where",
    when: "When",
